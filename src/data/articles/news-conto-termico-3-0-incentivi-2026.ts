...
const article: Article = {
  slug: 'news-conto-termico-3-0-incentivi-2026',
  title: 'Conto Termico 3.0 2026: incentivi fino al 65% GSE',
  h1: 'Conto Termico 3.0 nel 2026: incentivi fino al 65% per pompe di calore e solare termico',
  category: 'news',
  subcategory: 'Bonus & Fisco',
  excerpt:
    'Il Conto Termico 3.0 eroga incentivi diretti GSE fino al 65% per pompe di calore, solare termico e biomasse: requisiti, domanda e tempi di erogazione.',
  keywords: [
    'conto termico 3.0',
    'conto termico 2026',
    'incentivi pompe di calore 2026',
    'GSE incentivi termici',
    'solare termico incentivi',
    'sostituzione caldaia incentivi 2026',
    'conto termico requisiti',
    'conto termico o ecobonus',
    'incentivo 65% pompa di calore',
  ...
  faq: [
    {
      q: 'Che cos’è il Conto Termico 3.0?',
      a: 'È la versione aggiornata del meccanismo di incentivazione diretta gestito dal GSE per la produzione di energia termica da fonti rinnovabili e l’efficientamento energetico: a differenza dei bonus fiscali non è una detrazione IRPEF, ma un contributo in denaro erogato sul conto corrente, in un’unica soluzione per gli importi minori o in rate annuali per quelli maggiori.',
    },
    {
      q: 'Quali interventi incentiva il Conto Termico 3.0?',
      a: 'Pompe di calore elettriche e a gas in sostituzione di generatori esistenti, collettori solari termici, caldaie e generatori a biomassa, sistemi ibridi, e interventi sull’involucro edilizio. Per ciascuna tipologia il decreto fissa requisiti minimi di prestazione, massimali di spesa ammissibile e percentuali di copertura, che per le tecnologie rinnovabili possono arrivare fino al 65%.',
    },
    {
      q: 'Quanto tempo passa tra domanda e pagamento del Conto Termico?',
      a: 'Per le domande complete e corrette l’istruttoria GSE richiede in genere alcuni mesi: i tempi medi osservati sulle pratiche 2025-2026 si attestano tra 2 e 6 mesi dalla presentazione, con richieste di integrazione che possono allungare il percorso. L’erogazione avviene a bonifico, in un’unica soluzione sotto la soglia prevista o in rate annuali sopra.',
    },
    {
      q: 'Il Conto Termico è cumulabile con Ecobonus o Bonus ristrutturazioni?',
      a: 'No: la regola generale vieta la cumulabilità con le detrazioni fiscali sulla stessa spesa. È però possibile usare il Conto Termico per un intervento (ad esempio la pompa di calore) e le detrazioni ordinarie per interventi diversi sullo stesso immobile (ad esempio il rifacimento dei bagni), mantenendo pratiche e contabilità separate.',
    },
    {
      q: 'Chi può accedere al Conto Termico 3.0?',
      a: 'Privati cittadini, condomini, imprese, titolari di reddito agrario e pubbliche amministrazioni, su edifici esistenti. È la misura ideale per chi non ha capienza IRPEF — pensionati con detrazioni già assorbite, partite IVA in perdita, condomini — perché l’incentivo non dipende dal reddito né dall’imposta dovuta.',
    },
    {
      q: 'Il Conto Termico 3.0 ha una scadenza o un limite di fondi?',
      a: 'Non ha una scadenza annuale come i bonus fiscali: le dotazioni sono stanziate su base pluriennale e finora non hanno mostrato segnali di esaurimento. Il rischio reale è l’aggiornamento delle tabelle incentivanti: l’incentivo si fissa con la presentazione della domanda, non con il preventivo, quindi conviene non procrastinare.',
    },
  ],
  sections: [
    {
      heading: 'La notizia in breve: il Conto Termico 3.0 nel 2026',
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Resta ammessa anche una fascia di interventi sull’involucro: [coibentazioni di pareti e coperture](/articolo/top-10-materiali-isolanti-cappotto-termico) e sostituzione di serramenti, con intensità di aiuto più contenute rispetto alle rinnovabili termiche. Per questi interventi la convenienza rispetto all’Ecobonus va valutata caso per caso: l’[Ecobonus](/categoria/bonus-fisco) detrae il 50% sulla prima casa in 10 anni, il Conto Termico eroga una quota minore ma subito e senza vincoli di capienza fiscale.',
      ],
    },
    {
      heading: 'A chi conviene il Conto Termico rispetto all’Ecobonus?',
      paragraphs: [
    ...
    {
      heading: 'Quali errori fanno decadere la domanda di Conto Termico?',
      paragraphs: [
