...
const article: Article = {
  slug: 'news-superbonus-eredita-cosa-cambia-2026',
  title: 'Superbonus eredità 2026: cosa succede a detrazioni e crediti',
  h1: 'Superbonus ed eredità nel 2026: detrazioni residue, crediti e successioni, cosa cambia',
  category: 'news',
  subcategory: 'Bonus & Fisco',
  excerpt:
    "Superbonus ed eredità 2026: come si trasferiscono agli eredi detrazioni residue e crediti del 110%, le regole dell'Agenzia delle Entrate e le alternative.",
  keywords: [
    'superbonus 2026',
    'superbonus eredità',
    'superbonus successione eredi',
    'cessione credito superbonus 2026',
    'crediti fiscali edilizi incagliati',
    'detrazione superbonus eredi',
    'Agenzia delle Entrate detrazioni successione',
    'superbonus cosa resta',
    'bonus ristrutturazioni 2026',
    'conto termico 3.0',
  ],
  publishedAt: '2026-06-17T09:00:00+02:00',
  updatedAt: '2026-07-15T10:00:00+02:00',
  author: { name: 'Marco Ferretti', role: 'Caporedattore' },
  readingTime: 10,
  faq: [
    {
      q: 'Il Superbonus esiste ancora nel 2026?',
      a: 'No, non per i nuovi cantieri: l’aliquota del 110% è terminata e nel 2026 non esistono riaperture generalizzate. Restano attive le posizioni maturate negli anni precedenti: quote di detrazione da recuperare in dichiarazione, crediti da cessione ancora in capo a imprese e soggetti privati, e le fattispecie residue definite dalla normativa di chiusura.',
    },
    {
      q: 'Cosa succede al Superbonus in caso di morte del beneficiario?',
      a: 'Le quote residue di detrazione si trasferiscono all’erede che conserva la detenzione materiale dell’immobile oggetto dei lavori: deve cioè abitarlo o comunque disporne. Se nessun erede detiene l’immobile, la detrazione residua si perde. Il principio segue le regole generali dell’Agenzia delle Entrate sulle detrazioni edilizie in successione.',
    },
    {
      q: 'Gli eredi rischiano il recupero delle somme del Superbonus?',
      a: 'Sì, nei limiti previsti dalla legge: le posizioni irregolari seguono l’asse ereditario e il recupero delle somme indebitamente fruite può coinvolgere gli eredi secondo le regole della successione. Prima di accettare un’eredità con immobili ristrutturati al 110% è prudente esaminare titolo edilizio, asseverazioni e bonifici del cantiere.',
    },
    {
      q: 'I crediti Superbonus incagliati si possono ancora cedere?',
      a: 'Le cessioni ulteriori restano possibili solo nei limiti e con i vincoli fissati dalla normativa vigente, che ha progressivamente ristretto platea e requisiti. Le banche valutano i crediti con forte prudenza: la documentazione completa (titolo abilitativo, asseverazioni, congruità) è la condizione per qualsiasi trattativa. Molti contribuenti scelgono l’uso diretto in dichiarazione o le dilazioni previste.',
    },
    {
      q: 'Come si recupera la detrazione Superbonus in dichiarazione nel 2026?',
      a: 'Le quote si espongono nel quadro dedicato del modello 730 o del Modello Redditi, con rateizzazione in 4 o 10 annualità a seconda della fattispecie e delle opzioni esercitate. Serve capienza IRPEF sufficiente: l’eccedenza non si recupera. La documentazione di cantiere va conservata per l’intero periodo di fruizione.',
    },
    {
      q: 'Quali bonus usare al posto del Superbonus per i nuovi lavori?',
      a: 'Per i cantieri avviati nel 2026 il riferimento sono le detrazioni ordinarie: Bonus ristrutturazioni al 50% sull’abitazione principale (36% sulle altre unità) fino a 96.000 euro, Ecobonus con massimali per intervento, Sismabonus fino all’80% per la riduzione del rischio sismico e Conto Termico 3.0 con incentivo diretto GSE.',
    },
  ],
  sections: [
    {
      heading: 'La notizia in breve: cosa resta del Superbonus nel 2026',
      paragraphs: [
    ...
    {
      heading: 'Chi eredita le quote residue della detrazione Superbonus?',
      paragraphs: [
    ...
    {
      heading: 'I crediti Superbonus incagliati si possono ancora cedere nel 2026?',
      paragraphs: [
    ...
    {
      heading: 'Cosa succede ai crediti già ceduti in caso di successione?',
      paragraphs: [
    ...
    {
      heading: 'Controlli e contenzioso: il punto sull’attività di verifica',
      paragraphs: [
    ...
    {
      heading: 'Quali bonus usare al posto del Superbonus nel 2026?',
      paragraphs: [
        'Per chi oggi pianifica lavori — eredi compresi, che spesso ristrutturano proprio gli immobili ricevuti in successione — il panorama operativo del 2026 è quello delle detrazioni ordinarie. [Bonus ristrutturazioni al 50%](/articolo/news-bonus-ristrutturazioni-50-2026) sull’abitazione principale e al 36% sulle altre unità, con massimale di 96.000 euro e recupero in 10 anni; [Ecobonus](/articolo/top-5-bonus-edilizi-2026) con la stessa doppia aliquota e massimali dedicati per cappotto, generatori e infissi; Sismabonus fino all’80% per il miglioramento di due classi di rischio.',
        'A questi si aggiunge il [Conto Termico 3.0](/articolo/news-conto-termico-3-0-incentivi-2026), incentivo diretto GSE particolarmente utile per chi, come molti eredi, ha redditi medio-bassi e poca capienza IRPEF: l’incentivo non richiede detrazione e arriva sul conto corrente in tempi brevi. La regola trasversale resta la non cumulabilità sulla stessa spesa, con possibilità di combinare misure diverse su interventi diversi.',
        'Il cambio di paradigma rispetto agli anni del 110% è netto: finita l’era del "tutto gratis" a carico della fiscalità generale, il 2026 premia la pianificazione. Un computo metrico serio, un tecnico che confronti [i regimi incentivo](/categoria/bonus-fisco) prima dell’apertura del cantiere e una verifica preventiva della capienza fiscale valgono oggi più di qualsiasi aliquota maggiorata.',
      ],
    },
  ],
};
