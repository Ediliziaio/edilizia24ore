...
const article: Article = {
  ...
  title: 'Bonus edilizi 2026: i 5 incentivi attivi e come usarli',
  h1: 'Bonus edilizi 2026: la Top 5 degli incentivi ancora attivi per ristrutturare',
  category: 'top-5',
  excerpt:
    'Bonus ristrutturazioni 50%, Ecobonus, Sismabonus, Conto Termico 3.0 e Bonus mobili: la guida ai 5 bonus edilizi 2026 con aliquote, massimali e requisiti.',
  keywords: [
    'bonus edilizi 2026',
  ...
  faq: [
    {
      q: 'Quali sono i bonus edilizi attivi nel 2026?',
      a: 'Nel 2026 le cinque misure principali sono: Bonus ristrutturazioni (50% prima casa, 36% altre unità, massimale 96.000 euro), Ecobonus per l’efficientamento energetico, Sismabonus per gli interventi antisismici, Conto Termico 3.0 con incentivo diretto GSE e Bonus mobili ed elettrodomestici per gli arredi legati a una ristrutturazione agevolata.',
    },
    {
      q: 'Il Superbonus esiste ancora nel 2026?',
      a: 'Il Superbonus al 110% è concluso da tempo: nel 2026 restano attive solo le code di spesa già sostenute negli anni precedenti, con le relative quote di detrazione o i crediti residui, e le fattispecie residue previste per specifici casi. Per i nuovi lavori il riferimento sono le detrazioni ordinarie al 50% e al 36%.',
    },
    {
      q: 'Quando scadono i bonus edilizi del 2026?',
      a: 'Le detrazioni fiscali ordinarie (Bonus ristrutturazioni ed Ecobonus) valgono per i bonifici effettuati entro il 31 dicembre 2026; dal 2027, secondo l’impianto della Legge di Bilancio 2026, le aliquote sono previste in riduzione. Il Conto Termico 3.0 non ha una scadenza annuale ma dipende dalle dotazioni GSE e dagli aggiornamenti delle tabelle.',
    },
    {
      q: 'Si possono cumulare più bonus sullo stesso immobile?',
      a: 'Sì, ma mai sulla stessa spesa: la regola della non cumulabilità impone che ogni fattura sia coperta da un solo incentivo. È però possibile applicare bonus diversi a interventi diversi sullo stesso immobile (ad esempio Ecobonus per il cappotto e Bonus ristrutturazioni per il bagno), tenendo separate pratiche e contabilità.',
    },
    {
      q: 'Come si paga per non perdere la detrazione?',
      a: 'Per i bonus fiscali serve sempre il bonifico bancario o postale parlante, con causale che richiama la norma agevolativa, codice fiscale di chi detrae e partita IVA o codice fiscale del beneficiario del pagamento. Il Conto Termico 3.0 segue invece una procedura diversa, con domanda al GSE e incentivo erogato direttamente.',
    },
    {
      q: 'Cosa cambia per le seconde case nel 2026?',
      a: 'Per gli immobili diversi dall’abitazione principale le aliquote fiscali ordinarie sono ridotte: 36% invece di 50% per Bonus ristrutturazioni ed Ecobonus, a parità di massimali. Le misure non fiscali come il Conto Termico 3.0 mantengono invece incentivi indipendenti dalla destinazione d’uso dell’immobile.',
    },
  ],
  sections: [
    {
      heading: 'Bonus edilizi 2026: la Top 5 in sintesi',
      paragraphs: [
    ...
    {
      heading: '2. Quando conviene l’Ecobonus rispetto al Bonus ristrutturazioni?',
      paragraphs: [
    ...
    {
      heading: '3. Chi può richiedere il Sismabonus fino all’80%?',
      paragraphs: [
    ...
    {
      heading: '5. Bonus mobili ed elettrodomestici: il quinto da non dimenticare',
      paragraphs: [
        ...
        'Il coordinamento temporale è il punto critico: il titolo edilizio deve precedere l’acquisto, e la detrazione si aggancia all’unità immobiliare ristrutturata. [Chi pianifica cucina, armadi ed elettrodomestici insieme al cantiere](/articolo/top-5-tendenze-design-cucine-2026) può sommare il beneficio a quello del Bonus ristrutturazioni, rispettando però la separazione documentale tra le due spese.',
      ],
    },
    {
      heading: 'Cessione del credito e sconto in fattura: lo stato dell’arte',
      paragraphs: [
        'Una nota a margine che riguarda tutte le misure della Top 5: nel 2026 cessione del credito e sconto in fattura restano escluse per le spese ordinarie, dopo la stretta avviata negli anni scorsi per contenere la spesa pubblica. Le uniche finestre residue riguardano casi specifici e soggetti fragili, secondo le discipline speciali tuttora vigenti, e le code di crediti maturati con il [Superbonus](/articolo/news-superbonus-eredita-cosa-cambia-2026), oggetto di piani di rimborso e ulteriori cessioni limitate.',
