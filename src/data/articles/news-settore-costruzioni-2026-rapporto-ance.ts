...
const article: Article = {
  slug: 'news-settore-costruzioni-2026-rapporto-ance',
  title: 'Rapporto ANCE 2026: costruzioni, investimenti e scenari',
  h1: 'Settore costruzioni 2026, il rapporto ANCE: investimenti, occupazione e scenari per il 2027',
  category: 'news',
  subcategory: 'Mercato',
  excerpt:
    'Rapporto ANCE 2026: investimenti in costruzioni sui 200 miliardi, in calo dopo il Superbonus ma a livelli storici. Dati, occupazione, PNRR e scenari 2027.',
  keywords: [
    'rapporto ANCE 2026',
    'settore costruzioni 2026',
    'investimenti costruzioni Italia',
    'produzione edilizia ISTAT',
    'occupazione edilizia addetti',
    'opere pubbliche PNRR 2026',
    'scenario costruzioni 2027',
    'bonus ristrutturazioni 50%',
    'carenza manodopera edile',
    'mercato ristrutturazioni Italia',
  ],
  publishedAt: '2026-07-10T09:30:00+02:00',
  updatedAt: '2026-07-10T09:30:00+02:00',
  author: { name: 'Geom. Nicola Trevisan', role: 'Corrispondente cantieri' },
  readingTime: 11,
  faq: [
    {
      q: 'Cosa dice il rapporto ANCE 2026 sul settore delle costruzioni?',
      a: "Il rapporto ANCE fotografa nel 2026 un settore in fase di normalizzazione dopo il ciclo straordinario del Superbonus: gli investimenti in costruzioni calano in termini reali rispetto ai massimi, ma restano su livelli storicamente elevati, intorno ai 200 miliardi di euro annui secondo le stime dell'associazione, con il residenziale in ristrutturazione che regge e le opere pubbliche legate al PNRR in fase di piena esecuzione.",
    },
    {
      q: 'Quante persone lavorano nell\u2019edilizia in Italia?',
      a: "Secondo le stime ANCE e le elaborazioni su dati ISTAT, il comparto delle costruzioni occupa in Italia oltre un milione e mezzo di addetti tra occupazione diretta e indotto, con una domanda di manodopera che resta superiore all'offerta: le imprese segnalano difficolt\u00e0 a reperire figure tecniche e maestranze specializzate, dall'installatore termotecnico al carpentiere.",
    },
    {
      q: 'Il calo degli investimenti nel 2026 \u00e8 dovuto alla fine del Superbonus?',
      a: "In larga parte s\u00ec. L'uscita di scena del Superbonus 110% ha ridotto il flusso di ristrutturazioni trainato dagli incentivi straordinari, riportando il mercato sui livelli sostenibili dei bonus ordinari (ristrutturazioni al 50%, Ecobonus, Sismabonus). Il calo \u00e8 per\u00f0 parzialmente compensato dalla tenuta della domanda di riqualificazione energetica e dall'accelerazione delle opere pubbliche finanziate dal PNRR.",
    },
    {
      q: 'Perch\u00e9 le imprese edili non trovano operai?',
      a: "Le cause sono strutturali: invecchiamento della forza lavoro, riduzione dei flussi migratori verso il settore, concorrenza di altri comparti sui giovani e percezione del cantiere come lavoro usurante. Le risposte in campo sono contratti di filiera con percorsi formativi, academy aziendali, istituti tecnici per le costruzioni e quote migratorie dedicate che il rapporto ANCE chiede di stabilizzare.",
    },
    {
      q: 'Quali sono le previsioni per il settore costruzioni nel 2027?',
      a: "Le previsioni ANCE per il 2027 indicano una stabilizzazione degli investimenti: il completamento dei progetti PNRR, la piena operativit\u00e0 dei fondi di coesione e il ciclo di riqualificazione energetica legato alla Direttiva Case Green dovrebbero compensare il venir meno dei bonus straordinari. Lo scenario centrale \u00e8 di una produzione stabile o in lieve crescita, con il non residenziale e le infrastrutture in ripresa.",
    },
    {
      q: 'Quanto pesa il PNRR sull\u2019edilizia nel 2026?',
      a: "Il PNRR \u00e8 nel 2026 il principale motore delle opere pubbliche: secondo le elaborazioni ANCE, i progetti finanziati dal Piano interessano cantieri per decine di miliardi di euro, dalla rigenerazione urbana alle scuole, dalle ferrovie alle infrastrutture idriche. La scadenza del 2026 per il completamento dei lavori rende l'anno decisivo per la messa a terra degli interventi.",
    },
  ],
  sections: [
    {
      heading: 'Rapporto ANCE 2026: un settore in normalizzazione, non in crisi',
      paragraphs: [
    ...
    {
      heading: 'Opere pubbliche e PNRR: il 2026 \u00e8 l\u2019anno della verit\u00e0',
      paragraphs: [
    ...
    {
      heading: 'Perch\u00e9 manca manodopera nei cantieri? Occupazione e salari',
      paragraphs: [
    ...
    {
      heading: 'Cosa succeder\u00e0 nel 2027? Gli scenari ANCE e le tre incognite',
      paragraphs: [
