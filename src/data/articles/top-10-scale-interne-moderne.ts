...
const article: Article = {
  slug: 'top-10-scale-interne-moderne',
  title: 'Scale Interne Moderne: Top 10 del 2026, Tipologie e Prezzi',
  h1: 'Le 10 migliori scale interne moderne del 2026: tipologie, materiali e prezzi',
  category: 'top-10',
  excerpt:
    'Classifica delle 10 migliori scale interne moderne 2026: autoportanti, sospese e chiocciola a confronto. Scopri prezzi, ingombri e norme per la scala su misura.',
  keywords: [
    'scale interne moderne',
    'scala autoportante',
    'scala a chiocciola prezzi',
    'scala sospesa a sbalzo',
    'scale interne 2026',
    'quanto costa una scala interna su misura',
    'pedata e alzata regola di Blondel',
    'scala per soppalco',
    'Fontanot Rintal Mobirolo',
    'apertura foro solaio pratica strutturale',
  ],
  ...
  faq: [
    {
      q: 'Quanto spazio serve per una scala interna?',
      a: 'Per superare un dislivello di 2,70-3,00 metri una scala a rampa rettilinea richiede uno sviluppo di 3,5-4,5 metri e una larghezza di 80-90 cm; una scala a chiocciola si risolve in un ingombro circolare di 130-160 cm di diametro. La regola ergonomica 2 alzate + pedata = 62-64 cm determina il numero di gradini.',
    },
    {
      q: 'Quanto costa una scala interna su misura nel 2026?',
      a: 'Nel 2026 una scala modulare a kit costa 1.200-3.500 euro, una chiocciola in acciaio e legno 1.500-4.000 euro, una autoportante su misura in legno e acciaio 5.000-12.000 euro, una sospesa a sbalzo o in vetro strutturale 8.000-25.000 euro. La posa incide per il 10-20% e richiede 1-3 giorni.',
    },
    {
      q: 'Cosa dice la normativa su pedata e alzata delle scale interne?',
      a: 'Per gli edifici residenziali valgono i regolamenti edilizi comunali, che in genere recepiscono: alzata massima 18-20 cm, pedata minima 25 cm, larghezza minima 80 cm, parapetto alto almeno 1 metro con interassi non valicabili da una sfera di 10 cm. La formula di Blondel (2 alzate + pedata = 62-64 cm) resta il riferimento ergonomico universale.',
    },
    {
      q: 'Meglio scala a chiocciola o a giorno per un soppalco?',
      a: 'La chiocciola vince sull\u2019ingombro (130-160 cm di diametro) e sul prezzo, ma i gradini a ventaglio sono meno comodi e sicuri per bambini e anziani. La scala a giorno rettilinea è più sicura e confortevole e, con struttura portante centrale, occupa sorprendentemente poco: è la scelta consigliata quando il soppalco è d\u2019uso quotidiano.',
    },
    {
      q: 'Serve un permesso per installare una scala interna?',
      a: 'Se la scala usa un foro esistente e non modifica la struttura, l\u2019intervento è generalmente libero o richiede una semplice comunicazione. Aprire un nuovo foro nel solaio è invece intervento strutturale: serve il progetto di un tecnico abilitato con pratica strutturale al Genio Civile e titolo abilitativo comunale (CILA strutturale o SCIA).',
    },
    {
      q: 'Come si calcola il numero di gradini di una scala?',
      a: 'Si divide il dislivello per l\u2019alzata desiderata: per 2,70 metri con alzate da 17,5 cm servono 15-16 gradini. La pedata si ricava dalla regola di Blondel (2 alzate + pedata = 62-64 cm): con un\u2019alzata di 17,5 cm la pedata corretta è di 27-29 cm.',
    },
  ],
  table: {
    caption: 'Scale interne moderne 2026: le 10 tipologie a confronto',
    columns: ['Tipologia', 'Prezzo indicativo', 'Ingombro minimo', 'Punto di forza', 'Ideale per'],
    rows: [
      ['Scala a giorno autoportante', '5.000-12.000 €', 'Rampa 3,75-4,50 m', 'Il miglior compromesso assoluto', 'La casa principale'],
      ['Scala sospesa a sbalzo', '8.000-18.000 €', 'Come la scala a giorno', 'Effetto fluttuante', 'Scenografie su muro portante'],
      ['Scala a chiocciola', '1.500-4.000 €', 'Diametro 130-160 cm', 'Regina degli spazi ridotti', 'Soppalchi e piccoli ambienti'],
      ['Scala elicoidale', '12.000-30.000 €', 'Su progetto', 'Doppia curva scultorea', 'Ingressi scenografici'],
      ['Scala modulare componibile', '1.200-3.500 €', 'Regolabile in kit', 'Installazione in un giorno', 'Seconde case e soppalchi'],
      ['Scala in acciaio e vetro', '8.000-15.000 €', 'Rampa standard', 'Parapetti in vetro extra-chiaro', 'Open space minimal'],
      ['Scala in cemento rivestita', '4.000-9.000 €', 'Su struttura esistente', 'Solida e silenziosa', 'Rivestimenti su misura'],
      ['Scala floating monotrave', '6.000-14.000 €', 'Sviluppo lineare ridotto', 'Leggerezza visiva', 'Ambienti compatti a giorno'],
      ['Scala retrattile motorizzata', '2.000-6.000 €', 'Solo la botola', 'Scompare quando non serve', 'Soppalchi d\u2019uso occasionale'],
      ['Scala in vetro strutturale', 'Oltre 20.000 €', 'Su progetto', 'Progetti firmati', 'Pezzi unici di design'],
    ],
  },
  sections: [
    {
      heading: 'La risposta in sintesi: qual è la migliore scala interna moderna del 2026',
      paragraphs: [
        ...
        'La scala interna ha smesso di essere un puro elemento funzionale: nel 2026 è il pezzo d\u2019arredo architettonico più richiesto nelle [ristrutturazioni con soppalchi, loft e duplex](/articolo/top-10-imprese-ristrutturazione-milano-2026). Il mercato offre tre famiglie — modulari in kit, su misura artigianali e sistemi strutturali firmati — con marchi italiani come Fontanot, Rintal e Mobirolo che esportano in tutto il mondo e una filiera di carpenterie specializzate capace di realizzare progetti unici.',
      ],
    },
    {
      heading: 'La classifica completa: le 10 tipologie migliori a confronto',
      paragraphs: [
    ...
    {
      heading: 'Come scegliere la scala interna? Ergonomia, ingombri e regola di Blondel',
      paragraphs: [
        ...
        'Il secondo vincolo è il foro solaio: per salire comodi serve una luce di almeno 75-80 cm di larghezza e uno sviluppo pari alla rampa più 90-100 cm di sbarco. [Verificate l\u2019altezza libera sotto la rampa in partenza](/articolo/top-5-strumenti-laser-cantiere) (minimo 2,10 metri) e la direzione di salita rispetto a porte e finestre. Il terzo vincolo è strutturale: aprire o allargare un foro richiede sempre il calcolo di un ingegnere, con telaio di rinforzo perimetrale su solai in laterocemento.',
      ],
    },
    {
      heading: 'Materiali e finiture: legno, acciaio, vetro e tendenze 2026',
      paragraphs: [
        ...
        'Le tendenze del 2026: gradini in rovere sbiancato o fumé abbinati a strutture nere sottili; corrimano integrati con illuminazione LED a luce radente sui gradini, utile e scenografica; ringhiere a montanti verticali che sostituiscono i cavi orizzontali, più sicuri per i bambini; microcemento su strutture esistenti per continuità con i [pavimenti](/articolo/top-10-pavimenti-interni-2026). La sostenibilità avanza: legni certificati FSC, vernici all\u2019acqua e strutture interamente smontabili e riciclabili a fine vita.',
      ],
    },
    {
      heading: 'Quanto costa una scala interna nel 2026? Prezzi e budget da prevedere',
      paragraphs: [
    ...
    {
      heading: 'Cosa dice la normativa sulle scale interne? Sicurezza e verifiche',
      paragraphs: [
    ...
    {
      heading: 'Errori da evitare e consigli finali per la scelta',
      paragraphs: [
