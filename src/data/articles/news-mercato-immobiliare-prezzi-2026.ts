...
const article: Article = {
  slug: 'news-mercato-immobiliare-prezzi-2026',
  title: 'Prezzi case 2026: crescono ancora, la mappa citt\u00e0 per citt\u00e0',
  h1: 'Mercato immobiliare 2026: prezzi delle case in crescita, Milano guida, i dati citt\u00e0 per citt\u00e0',
  category: 'news',
  subcategory: 'Mercato',
  excerpt:
    'Prezzi case 2026: secondo le elaborazioni su dati ISTAT e OMI le quotazioni salgono del 2-4%, trainate da Milano e dal Nord. Mappa citt\u00e0 per citt\u00e0 e previsioni.',
  keywords: [
    'prezzi case 2026',
    'mercato immobiliare Italia 2026',
    'quotazioni immobiliari OMI',
    'prezzi case Milano 2026',
    'ISTAT prezzi abitazioni',
    'andamento compravendite 2026',
    'mutui green tassi 2026',
    'green premium immobili classe energetica',
    'prezzi case Roma Torino Bologna',
    'previsioni mercato immobiliare 2027',
  ],
  ...
  faq: [
    {
      q: 'Di quanto sono aumentati i prezzi delle case nel 2026?',
      a: "Secondo le prime elaborazioni su dati ISTAT e OMI, i prezzi delle abitazioni in Italia registrano nel 2026 una crescita media tendenziale nell'ordine del 2-4%, con il nuovo che corre pi\u00f9 dell'usato. La forbice tra citt\u00e0 resta ampia: Milano e alcune citt\u00e0 del Nord superano il 4-5%, mentre diverse aree del Centro-Sud restano su variazioni nulle o appena positive.",
    },
    {
      q: 'Quanto costa una casa a Milano nel 2026?',
      a: "Milano resta la piazza pi\u00f9 cara d'Italia: le quotazioni medie si collocano secondo le stime degli operatori oltre i 5.000 euro al metro quadrato per l'abitativo medio, con punte ampiamente superiori nelle zone centrali e nei nuovi sviluppi. Il nuovo e il ristrutturato in classe energetica elevata registrano i rialzi pi\u00f9 sostenuti.",
    },
    {
      q: 'Le compravendite sono in aumento o in calo nel 2026?',
      a: "Dopo il rallentamento legato al ciclo dei tassi, le compravendite residenziali mostrano nel 2026 segnali di stabilizzazione: secondo le stime basate sui dati di compravendita dell'Agenzia delle Entrate e dell'OMI, i volumi si attestano su livelli vicini a quelli dell'anno precedente, sostenuti dal calo dei tassi sui mutui e dalla domanda di abitazioni efficienti.",
    },
    {
      q: 'In quali citt\u00e0 i prezzi crescono di pi\u00f9 nel 2026?',
      a: "Oltre a Milano, le prime stime 2026 segnalano rialzi nell'ordine del 3-5% a Torino e Bologna, spinte da universit\u00e0 e servizi, con Firenze sostenuta dalla domanda internazionale. Al Sud le variazioni positive si concentrano nei quartieri centrali di Napoli, Bari e Palermo e nelle zone a vocazione turistica, mentre i capoluoghi minori e le aree interne restano deboli.",
    },
    {
      q: 'Conviene comprare il nuovo o l\u2019usato nel 2026?',
      a: "Il nuovo conviene in termini di efficienza energetica, spese di gestione e accesso a mutui green, ma costa in media il 15-25% in pi\u00f9 dell'usato. L'usato resta pi\u00f9 accessibile e spesso meglio posizionato, ma richiede di valutare i costi di ristrutturazione: con il Bonus ristrutturazioni al 50% la riqualificazione dell'usato resta competitiva, specie nelle citt\u00e0 dove lo sconto sul prezzo d'acquisto \u00e8 consistente.",
    },
    {
      q: 'I prezzi delle case scenderanno nel 2027?',
      a: "Le previsioni degli analisti per il 2027 indicano una prosecuzione della fase di crescita moderata: con tassi sui mutui in normalizzazione, domanda di case efficienti in aumento e offerta di nuovo limitata nei grandi centri, lo scenario centrale \u00e8 di prezzi stabili o in lieve rialzo. Rischio ribasso concentrato sulle aree con eccesso di offerta e calo demografico.",
    },
  ],
  sections: [
    {
      heading: 'Mercato immobiliare 2026: il quadro generale dei prezzi delle case',
      paragraphs: [
    ...
    {
      heading: 'Quanto costa il nuovo rispetto all\u2019usato? Il green premium si allarga',
      paragraphs: [
    ...
    {
      heading: 'I prezzi delle case scenderanno nel 2027? Le previsioni degli analisti',
      paragraphs: [
