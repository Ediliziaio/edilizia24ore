...
const article: Article = {
  slug: 'news-rigenerazione-urbana-progetti-2026',
  title: 'Rigenerazione urbana 2026: i progetti che cambiano le citt\u00e0',
  h1: 'Rigenerazione urbana, i progetti 2026 in Italia: aree dismesse, ex scali ferroviari e periferie che rinascano',
  category: 'news',
  subcategory: 'Sostenibilit\u00e0',
  excerpt:
    'Rigenerazione urbana 2026: progetti PNRR e aree dismesse a Milano, Roma e Torino: miliardi di investimenti trasformano le citt\u00e0. La mappa degli interventi.',
  keywords: [
    'rigenerazione urbana 2026',
    'aree dismesse recupero',
    'ex scali ferroviari Milano',
    'progetti PNRR citt\u00e0 periferie',
    'riqualificazione periferie',
    'consumo di suolo zero',
    'urbanistica 2026',
    'Villaggio Olimpico Milano Porta Romana',
    'bonifiche aree industriali',
    'ISPRA consumo di suolo',
  ],
  publishedAt: '2026-06-08T08:30:00+02:00',
  updatedAt: '2026-06-08T08:30:00+02:00',
  author: { name: 'Arch. Beatrice Ongaro', role: 'Redattrice architettura e design' },
  readingTime: 10,
  faq: [
    {
      q: 'Cos\u2019\u00e8 la rigenerazione urbana?',
      a: "La rigenerazione urbana \u00e8 l'insieme degli interventi di recupero, riqualificazione e rifunzionalizzazione di aree ed edifici gi\u00e0 urbanizzati — aree industriali dismesse, ex scali ferroviari, caserme, quartieri degradati — alternativi al consumo di nuovo suolo. Comprende demolizioni e ricostruzioni, riconversioni d'uso, nuovi spazi pubblici, verde e servizi.",
    },
    {
      q: 'Quanto investe l\u2019Italia in rigenerazione urbana nel 2026?',
      a: "Il 2026 \u00e8 l'anno di picco degli investimenti: ai progetti finanziati dal PNRR — che per le aree urbane e le periferie stanzia miliardi di euro — si sommano i grandi progetti privati di trasformazione nelle principali citt\u00e0, stimati dagli osservatori in decine di miliardi di euro complessivi tra cantieri avviati e in pipeline.",
    },
    {
      q: 'Quali sono i principali progetti di rigenerazione a Milano?',
      a: "Milano concentra alcuni dei progetti pi\u00f9 grandi d'Europa: la trasformazione degli ex scali ferroviari (Farini, San Cristoforo, Porta Romana e altri), il distretto olimpico di Porta Romana con il Villaggio Olimpico destinato a diventare residenziale dopo i Giochi invernali 2026, oltre a quartieri in completamento come CityLife e Porta Nuova.",
    },
    {
      q: 'Quali progetti di rigenerazione riguardano Roma e il Sud?',
      a: "Roma lavora sulla stazione Tiburtina, sulle borgate e sul recupero di edifici pubblici dismessi per housing e servizi, nel solco degli interventi legati al Giubileo. Al Sud spiccano Bagnoli a Napoli — tra le bonifiche pi\u00f9 attese del Mezzogiorno — e i programmi integrati di Bari, Palermo e Catania finanziati con fondi PNRR e di coesione, tra riqualificazione edilizia, mobilit\u00e0 e verde urbano.",
    },
    {
      q: 'Il PNRR finanzia la rigenerazione urbana?',
      a: "S\u00ec. Il PNRR destina alle citt\u00e0 risorse per programmi integrati di rigenerazione: progetti urbani per le aree degradate delle grandi citt\u00e0, interventi nelle periferie delle aree metropolitane, riqualificazione di piccoli comuni e borghi, edilizia residenziale pubblica. La scadenza del Piano al 2026 rende l'anno decisivo per l'avvio e il completamento dei cantieri finanziati.",
    },
    {
      q: 'La rigenerazione urbana riduce il consumo di suolo?',
      a: "\u00c8 il suo obiettivo principale: intervenire su aree gi\u00e0 urbanizzate evita l'urbanizzazione di nuovi terreni agricoli e naturali. L'Italia consuma ancora decine di ettari di suolo al giorno secondo le stime ISPRA, e la rigenerazione — insieme alla riqualificazione del patrimonio esistente — \u00e8 la leva indicata dalla legislazione europea e nazionale per arrivare al consumo di suolo netto zero al 2050.",
    },
  ],
  sections: [
    {
      heading: 'Rigenerazione urbana 2026: l\u2019anno del grande cantiere italiano',
      paragraphs: [
        ...
        "Il quadro normativo accompagna la transizione: la legislazione nazionale e le leggi regionali sul consumo di suolo premiano gli interventi su aree gi\u00e0 urbanizzate con procedure semplificate, premi di volumetria e strumenti fiscali, mentre la prospettiva europea del [consumo di suolo netto zero](/categoria/sostenibilita) al 2050 rende la rigenerazione non una scelta ma una direzione obbligata delle politiche urbane.",
      ],
    },
    {
      heading: 'Milano: dagli scali ferroviari al dopo-Olimpiade',
      paragraphs: [
        "Milano resta [il laboratorio nazionale della rigenerazione urbana](/articolo/top-10-imprese-ristrutturazione-milano-2026): i progetti di trasformazione degli ex scali ferroviari — Farini, San Cristoforo, Porta Romana, Greco-Breda e gli altri scali dell'accordo di programma con FS — rappresentano complessivamente uno dei pi\u00f9 grandi programmi di ricomposizione urbana d'Europa, con milioni di metri quadrati di nuove funzioni tra residenziale, direzionale, servizi e grandi parchi urbani. I cantieri avviati o in fase di attivazione definiranno il volto della citt\u00e0 per i prossimi vent'anni.",
    ...
    {
      heading: 'Roma, Torino e le altre citt\u00e0: la mappa dei progetti',
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Il modello vincente \u00e8 quello del partenariato pubblico-privato: i Comuni portano visione, standard e spazi pubblici; gli operatori privati portano capitale e velocit\u00e0 esecutiva; gli accordi di programma definiscono il mix di funzioni e le opere di urbanizzazione. Le esperienze migliori mostrano che la qualit\u00e0 urbana — parchi, servizi, connettivit\u00e0 — \u00e8 anche il principale motore di [valorizzazione immobiliare](/articolo/news-mercato-immobiliare-prezzi-2026): rigenerare bene conviene a tutti.",
      ],
    },
    {
      heading: 'La rigenerazione urbana riduce il consumo di suolo? L\u2019obiettivo zero',
      paragraphs: [
    ...
    {
      heading: 'Cosa serve per rigenerare davvero? Sfide e prospettive',
      paragraphs: [
