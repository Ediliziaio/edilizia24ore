...
const article: Article = {
  slug: 'news-direttiva-case-green-recepimento-italia',
  title: 'Direttiva Case Green 2026: recepimento Italia, cosa cambia',
  h1: 'Direttiva Case Green, il recepimento italiano della EPBD: cosa cambia per edifici, proprietari e imprese',
  category: 'news',
  subcategory: 'Normative',
  excerpt:
    "Direttiva Case Green: l'Italia recepisce la EPBD 2024/1275. Nuove classi APE, edifici a emissioni zero, stop caldaie a gas: scadenze 2030, deroghe e obblighi.",
  keywords: [
    'direttiva case green',
    'EPBD recepimento Italia',
    'direttiva case green 2024/1275',
    'edifici a emissioni zero',
    'certificato APE nuove classi',
    'caldaie a gas divieto',
    'prestazione energetica edifici',
    'ristrutturazioni profonde obbligo',
    'ENEA parco edilizio italiano',
    'riqualificazione energetica edifici 2030',
  ],
  ...
  faq: [
    {
      q: 'Che cos\u2019\u00e8 la Direttiva Case Green (EPBD)?',
      a: "La Direttiva Case Green \u00e8 la direttiva europea 2024/1275 sulla prestazione energetica degli edifici (EPBD). Fissa una traiettoria di decarbonizzazione del parco immobiliare UE al 2050, con obiettivi intermedi di riduzione dei consumi, ristrutturazioni profonde degli edifici peggiori e standard di edificio a emissioni zero per le nuove costruzioni.",
    },
    {
      q: 'Quando entra in vigore il recepimento italiano?',
      a: "Gli Stati membri avevano tempo fino a maggio 2026 per recepire la direttiva. L'Italia ha approvato il decreto legislativo di recepimento nel corso del 2026, con effetti graduali: le nuove regole su APE, sistemi tecnici e ristrutturazioni importanti si applicano da subito, mentre gli obiettivi di riduzione dei consumi del parco edilizio corrono al 2030 e al 2035.",
    },
    {
      q: 'Le caldaie a gas saranno vietate?',
      a: "La direttiva prevede la progressiva uscita dai combustibili fossili: dal 2040 nessun edificio alimentato esclusivamente a combustibile fossile dovrebbe restare nel parco immobiliare, e gi\u00e0 nelle nuove costruzioni a emissioni zero i generatori a gas non sono ammessi. Le caldaie esistenti non vanno sostituite subito, ma gli incentivi statali per la sostituzione con caldaie a gas stanno cessando.",
    },
    {
      q: 'La Direttiva Case Green obbliga a ristrutturare casa?',
      a: "Non esiste un obbligo diretto di ristrutturazione per il singolo proprietario: la direttiva fissa obiettivi di riduzione dei consumi medi dell'intero parco edilizio nazionale (\u201316% al 2030, \u201320/22% al 2035), da raggiungere con piani nazionali e incentivi. Gli obblighi puntuali riguardano invece le nuove costruzioni, le ristrutturazioni importanti e gli edifici non residenziali peggiori.",
    },
    {
      q: 'Cosa cambia per il certificato APE?',
      a: "Il recepimento introduce classi energetiche armonizzate a livello europeo, dalla A0 alla G, con scale nazionali riallineate. L'APE diventa pi\u00f9 dettagliato, integra indicatori su emissioni e infrastrutture di ricarica e assume un ruolo centrale nelle compravendite, nelle locazioni e nell'accesso agli incentivi.",
    },
    {
      q: 'Sono previste esenzioni per gli edifici storici?',
      a: "S\u00ec. La direttiva prevede deroghe per gli edifici tutelati per particolare valore architettonico o storico, per gli edifici di culto, per quelli di piccole dimensioni indipendenti e per casi di fattibilit\u00e0 tecnica ed economica non ragionevole. Spetta agli Stati membri definire l'ambito delle esenzioni nel recepimento nazionale.",
    },
  ],
  sections: [
    {
      heading: 'Direttiva Case Green: cosa prevede il recepimento italiano',
      paragraphs: [
    ...
    {
      heading: 'Cosa cambia per le nuove costruzioni? Lo standard a emissioni zero',
      paragraphs: [
    ...
    {
      heading: 'Quali obblighi per il parco edilizio esistente al 2030?',
      paragraphs: [
    ...
    {
      heading: 'Come cambia il certificato APE con la nuova scala europea?',
      paragraphs: [
        ...
        "Resta centrale il ruolo dell'APE nelle compravendite e nelle locazioni: il certificato deve essere disponibile gi\u00e0 in fase di annuncio e allegato al rogito o al contratto. Con la nuova scala europea, secondo gli osservatori, il differenziale di valore tra edifici in classi alte e basse — il cosiddetto [\u201cgreen premium\u201d](/articolo/news-mercato-immobiliare-prezzi-2026) — \u00e8 destinato a diventare pi\u00f9 visibile anche sul mercato italiano, dove le analisi OMI registrano gi\u00e0 differenze di prezzo percepibili tra immobili efficienti e non nelle grandi citt\u00e0.",
      ],
    },
    {
      heading: 'Deroghe, edifici storici e fattibilit\u00e0 tecnica: chi \u00e8 esente',
      paragraphs: [
