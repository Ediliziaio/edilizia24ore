...
const article: Article = {
  slug: 'news-prezzi-materiali-costruzione-2026',
  title: 'Prezzi materiali edili 2026: cemento, acciaio, legno',
  h1: 'Prezzi dei materiali da costruzione nel 2026: cemento stabile, acciaio in calo, legno in lieve rialzo',
  category: 'news',
  subcategory: 'Mercato',
  excerpt:
    'Prezzi materiali edili 2026: secondo i dati ISTAT si stabilizzano dopo gli anni degli aumenti. Cemento, acciaio, laterizi e legno: andamenti e previsioni.',
  keywords: [
    'prezzi materiali da costruzione 2026',
    'prezzo cemento 2026',
    'prezzo acciaio da costruzione',
    'listini materiali edili',
    'ISTAT prezzi costruzioni',
    'costo costruzione al mq 2026',
    'revisione prezzi appalti',
    'prezzo calcestruzzo al metro cubo',
    'prezzi laterizi e isolanti',
    'previsioni prezzi materiali edili 2027',
  ],
  ...
  faq: [
    {
      q: 'I prezzi dei materiali da costruzione scendono nel 2026?',
      a: "Nel 2026 i prezzi dei materiali da costruzione mostrano una stabilizzazione complessiva dopo la fiammata del 2021-2023: secondo gli indici ISTAT, alcune famiglie di prodotti come l'acciaio e gli energetivori registrano cali o variazioni nulle, mentre cemento, laterizi e prodotti a forte componente energetica si mantengono su livelli elevati. Il costo complessivo di costruzione resta comunque molto pi\u00f9 alto rispetto al 2020.",
    },
    {
      q: 'Quanto costa il cemento nel 2026?',
      a: "I prezzi del cemento nel 2026 si mantengono su livelli elevati, nell'ordine di una forchetta che gli operatori stimano tra i 130 e i 170 euro al metro cubo per il calcestruzzo preconfezionato consegnato in cantiere, con forti variazioni regionali e per classe di resistenza. Il costo risente del prezzo dell'energia e dei clinker, oltre che dei costi di trasporto.",
    },
    {
      q: 'L\u2019acciaio da costruzione costa meno rispetto al 2022?',
      a: "S\u00ec. Dopo i picchi record del 2021-2022, quando i tondini per cemento armato superarono livelli mai visti, i prezzi dell'acciaio da costruzione sono rientrati sensibilmente e nel 2026 viaggiano su quotazioni inferiori del 30-40% rispetto ai massimi, pur restando sopra i livelli pre-pandemia. La domanda europea debole e la concorrenza delle importazioni tengono sotto pressione i listini.",
    },
    {
      q: 'Quali materiali edili costano di pi\u00f9 nel 2026?',
      a: "Nel 2026 i prezzi pi\u00f9 sostenuti riguardano i prodotti a forte intensit\u00e0 energetica — cemento, laterizi, isolanti minerali — e i componenti impiantistici legati alla transizione energetica, come pompe di calore, cavi e quadri elettrici. In calo o stabili, secondo gli indici ISTAT, acciaio, laminati e i prodotti derivati dal petrolio, che seguono la debolezza della domanda industriale europea.",
    },
    {
      q: 'La revisione prezzi negli appalti pubblici si applica ancora?',
      a: "S\u00ec, il meccanismo di revisione prezzi previsto dal Codice dei contratti pubblici resta applicabile nei contratti di appalto quando la variazione dei prezzi dei materiali supera le soglie previste. Nel 2026, con i prezzi stabilizzati, il ricorso agli adeguamenti straordinari \u00e8 diminuito, ma resta fondamentale per i contratti pluriennali avviati negli anni della volatilit\u00e0.",
    },
    {
      q: 'Quanto incidono i materiali sul costo di costruzione di una casa?',
      a: "I materiali pesano mediamente per il 40-50% del costo diretto di costruzione di un edificio residenziale, con il resto coperto da manodopera, oneri e margini. Nel 2026 il costo medio di costruzione di una nuova abitazione in Italia \u00e8 stimato dagli operatori in una fascia tra i 1.500 e i 2.200 euro al metro quadrato, a seconda di zona, standard e classe energetica.",
    },
  ],
  sections: [
    {
      heading: 'Materiali da costruzione 2026: dopo la tempesta, la stabilizzazione',
      paragraphs: [
        "I prezzi dei materiali da costruzione si stabilizzano nel 2026: secondo gli [indici ISTAT](/categoria/mercato), le variazioni tendenziali tornano contenute dopo gli aumenti a doppia cifra del 2021-2023. L'acciaio scende del 30-40% rispetto ai massimi, il cemento resta fermo e il costo di costruzione di una nuova abitazione si colloca tra 1.500 e 2.200 euro al metro quadrato.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "A sostenere i prezzi restano i costi energetici del ciclo del clinker, il cuore energivoro della produzione cementizia, e gli investimenti delle cementerie per la decarbonizzazione: la filiera \u00e8 impegnata nella riduzione delle emissioni con carburanti alternativi, clinker ridotto e [sperimentazioni di cattura della CO2](/articolo/news-calcestruzzo-sostenibile-innovazioni), costi che si riflettono sul listino. La domanda interna, normalizzata dopo il Superbonus, non esercita per\u00f2 pi\u00f9 la pressione degli anni scorsi, e questo tiene i prezzi fermi.",
    ...
    {
      heading: 'L\u2019acciaio da costruzione costa meno? Il raffreddamento dei listini',
      paragraphs: [
    ...
    {
      heading: 'Legno, laterizi e isolanti: tre filiere, tre andamenti',
      paragraphs: [
    ...
    {
      heading: 'Quanto costa costruire una casa nel 2026? Costi e previsioni',
      paragraphs: [
