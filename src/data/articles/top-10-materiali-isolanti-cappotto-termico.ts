...
const article: Article = {
  slug: 'top-10-materiali-isolanti-cappotto-termico',
  title: 'Cappotto Termico: Top 10 Isolanti 2026, Classifica e Prezzi',
  h1: 'I 10 migliori materiali isolanti per il cappotto termico nel 2026',
  category: 'top-10',
  excerpt:
    'I 10 migliori materiali isolanti per cappotto termico 2026: EPS grafite, lana di roccia e fibra di legno a confronto. Scopri prezzi al mq, spessori e bonus.',
  keywords: [
    'cappotto termico',
    'materiali isolanti cappotto',
    'EPS grafite',
    'lana di roccia facciata',
    'quanto costa il cappotto termico al mq',
    'spessore cappotto termico zona climatica',
    'conduttività termica isolanti lambda',
    'fibra di legno o EPS',
    'Ecobonus cappotto 2026',
    'cappotto esterno condominio',
  ],
  ...
  faq: [
    {
      q: 'Qual è il miglior materiale per il cappotto termico esterno?',
      a: 'Per rapporto tra prestazioni e costo il materiale più usato è l\u2019EPS con grafite (lambda 0,031 W/mK), che copre circa il 70% dei cappotti italiani. La lana di roccia è preferibile dove servono reazione al fuoco in classe A1 e isolamento acustico, la fibra di legno dove conta lo sfasamento termico estivo.',
    },
    {
      q: 'Quanto costa un cappotto termico al metro quadro nel 2026?',
      a: 'Nel 2026 un cappotto in EPS grafite da 12-14 cm fornito e posato costa 70-100 euro al mq, ponteggi esclusi (altri 15-25 euro al mq). Lana di roccia e fibra di legno costano rispettivamente 90-120 e 100-140 euro al mq. Per un condominio di 1.000 mq di facciata il budget tipico è di 90.000-150.000 euro.',
    },
    {
      q: 'Che spessore deve avere il cappotto termico?',
      a: 'Dipende da zona climatica e materiale: in zona E-F, per rispettare i limiti di trasmittanza delle pareti (U ≤ 0,26-0,28 W/m²K), servono indicativamente 12-16 cm di EPS grafite o 14-18 cm di lana minerale su muratura esistente. Il calcolo esatto va fatto da un termotecnico sulla stratigrafia reale.',
    },
    {
      q: 'Il cappotto termico è detraibile nel 2026?',
      a: 'Sì: come intervento di riqualificazione energetica accede all\u2019Ecobonus con detrazione del 50% per l\u2019abitazione principale (36% per le altre unità) e, per parti comuni condominiali o requisiti specifici, al Conto Termico 3.0. In entrambi i casi servono trasmittanze conformi ai limiti e trasmissione della documentazione ENEA.',
    },
    {
      q: 'Cappotto esterno o insufflaggio: cosa conviene di più?',
      a: 'Il cappotto esterno offre prestazioni superiori perché elimina i ponti termici e protegge la muratura, ma richiede ponteggi e facciata libera da vincoli. L\u2019insufflaggio delle intercapedini costa un terzo (15-30 euro al mq) ed è ideale per muri a cassetta e edifici con vincoli estetici o storici.',
    },
    {
      q: 'Cappotto termico esterno o interno: quale scegliere?',
      a: 'Il cappotto esterno è tecnicamente superiore perché elimina i ponti termici e protegge la muratura dalle escursioni termiche, ma richiede ponteggio e facciata libera da vincoli. Il cappotto interno in calcio silicato o pannelli accoppiati costa 60-90 euro al mq e resta l\u2019unica via per edifici tutelati o per singole unità in condominio senza delibera assembleare.',
    },
  ],
  table: {
    caption: 'Cappotto termico 2026: i 10 migliori isolanti a confronto',
    columns: ['Materiale', 'Lambda (W/mK)', 'Prezzo posato al mq', 'Punto di forza', 'Ideale per'],
    rows: [
      ['EPS con grafite', '0,031', '70-100 €', 'Best buy leggero ed economico', 'La maggior parte dei cantieri'],
      ['Lana di roccia', '0,034-0,040', '90-120 €', 'Incombustibile A1 e fonoassorbente', 'Condomini e facciate alte'],
      ['Poliuretano PIR/PUR', '0,022-0,028', '90-130 €', 'Massime prestazioni a parità di spessore', 'Dove i centimetri contano'],
      ['Fibra di legno', '0,038-0,043', '100-140 €', 'Sfasamento estivo di 10-12 ore', 'Contro il caldo estivo'],
      ['Sughero biondo espanso', '0,037-0,040', '110-150 €', 'Naturale, resiste a muffe e insetti', 'Bioedilizia'],
      ['XPS', '0,033-0,037', '80-110 €', 'Estruso impermeabile', 'Zoccoli, basamenti e controterra'],
      ['Lana di vetro', '0,032-0,038', '80-110 €', 'Prestazioni minerali a costo inferiore', 'Budget attenti'],
      ['Calcio silicato', '0,045-0,059', '60-90 €', 'Rigido, alcalino e antimuffa', 'Cappotti interni e pareti umide'],
      ['Fibra di cellulosa', '0,038-0,040', '15-30 € (insufflaggio)', 'Nessun ponteggio', 'Muri a cassetta'],
      ['Aerogel in pannelli', '0,015-0,018', '80-120 €', 'Prestazioni record in 10-20 mm', 'Davanzali ed edifici vincolati'],
    ],
  },
  sections: [
    {
      heading: 'La risposta in sintesi: qual è il miglior isolante per il cappotto nel 2026',
      paragraphs: [
        ...
        'Il cappotto esterno resta l\u2019intervento di riqualificazione energetica più efficace sul patrimonio esistente: su una villetta in classe G può abbattere i consumi di riscaldamento del 30-45% e, abbinato a [infissi nuovi](/articolo/top-10-migliori-infissi-pvc-2026), consentire il salto di due classi energetiche. Nel 2026, con l\u2019Ecobonus al 50% e l\u2019avvicinarsi delle scadenze della [Direttiva Case Green](/articolo/news-direttiva-case-green-recepimento-italia), la domanda è tornata a crescere a doppia cifra.',
      ],
    },
    {
      heading: 'La classifica completa: i 10 migliori isolanti a confronto',
      paragraphs: [
    ...
    {
      heading: 'Come scegliere l\u2019isolante per il cappotto? I parametri che contano',
      paragraphs: [
    ...
    {
      heading: 'Quanto costa il cappotto termico nel 2026? Prezzi al metro quadro',
      paragraphs: [
    ...
    {
      heading: 'Che spessore deve avere il cappotto? Normativa e incentivi 2026',
      paragraphs: [
