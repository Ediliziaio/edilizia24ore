...
const article: Article = {
  slug: 'top-10-imprese-ristrutturazione-milano-2026',
  title: 'Top 10 Imprese Ristrutturazione Milano 2026: Prezzi',
  h1: 'Le 10 migliori imprese di ristrutturazione a Milano nel 2026: guida alla scelta',
  category: 'top-10',
  excerpt:
    'Le 10 migliori imprese di ristrutturazione a Milano 2026: costi al mq, preventivi e tempi a confronto. Scopri come scegliere l\u2019impresa giusta e i bonus attivi.',
  keywords: [
    'imprese ristrutturazione Milano',
    'ristrutturare casa Milano',
    'costi ristrutturazione Milano 2026',
    'ristrutturazione chiavi in mano Milano',
    'general contractor Milano',
    'preventivo ristrutturazione appartamento',
    'quanto costa ristrutturare un appartamento di 100 mq',
    'bonus ristrutturazioni 2026',
    'CILA SCIA ristrutturazione Milano',
    'migliori imprese edili Milano',
  ],
  ...
  faq: [
    {
      q: 'Quanto costa ristrutturare un appartamento di 100 mq a Milano nel 2026?',
      a: 'Nel 2026 una ristrutturazione completa chiavi in mano di un appartamento di 100 mq a Milano costa indicativamente tra 90.000 e 160.000 euro, IVA al 10% inclusa. Una ristrutturazione parziale, senza rifacimento degli impianti, si attesta tra 35.000 e 60.000 euro.',
    },
    {
      q: 'Quanto dura una ristrutturazione completa di un appartamento?',
      a: 'Per un trilocale con rifacimento di impianti, bagni e pavimenti i tempi medi di cantiere sono di 3-5 mesi, cui vanno aggiunte 4-8 settimane per progettazione, pratiche e scelta dei materiali. Le imprese più richieste a Milano hanno liste di attesa di 2-3 mesi prima dell\u2019avvio.',
    },
    {
      q: 'Serve un permesso per ristrutturare casa a Milano?',
      a: 'La manutenzione ordinaria è libera, la manutenzione straordinaria senza opere strutturali richiede la CILA, mentre per interventi che toccano parti strutturali o modificano la sagoma serve la SCIA o il permesso di costruire. Nel centro storico possono applicarsi vincoli della Soprintendenza.',
    },
    {
      q: 'Come verificare che un\u2019impresa di ristrutturazione sia affidabile?',
      a: 'Controllare visura camerale e anzianità dell\u2019impresa, DURC di regolarità contributiva, attestazione SOA se prevista, polizza RC e richiedere almeno tre referenze con cantieri visitabili. Un capitolato con computo metrico dettagliato e prezzi unitari è il segnale più concreto di professionalità.',
    },
    {
      q: 'Posso detrarre i lavori di ristrutturazione nel 2026?',
      a: 'Sì: nel 2026 il Bonus ristrutturazioni consente di detrarre il 50% delle spese sull\u2019abitazione principale (36% sulle altre unità) fino a 96.000 euro per unità immobiliare, recuperati in 10 quote annuali. L\u2019IVA agevolata al 10% si applica su manodopera e, con limiti, sui beni significativi.',
    },
    {
      q: 'Meglio un general contractor o artigiani separati per ristrutturare?',
      a: 'Il general contractor conviene per ristrutturazioni complete sopra i 60-80 mq: coordina progetto, pratiche e maestranze con un unico responsabile, riducendo ritardi e costi di interfaccia del 10-15%. Gli artigiani separati possono far risparmiare su opere semplici, ma richiedono al committente il ruolo di coordinatore e moltiplicano i rischi su tempi e garanzie.',
    },
  ],
  table: {
    caption: 'Imprese di ristrutturazione a Milano 2026: le 10 tipologie a confronto',
    columns: ['Tipologia di impresa', 'Costo indicativo', 'Punto di forza', 'Ideale per'],
    rows: [
      ['General contractor chiavi in mano', '1.000-1.600 €/mq', 'Un unico referente per progetto e cantiere', 'Ristrutturazioni sopra i 100 mq'],
      ['Specializzate in appartamenti in condominio', '700-1.100 €/mq', 'Autorizzazioni e lavori in edifici abitati', 'Singoli appartamenti'],
      ['Società di riqualificazione energetica certificate', 'Su computo per intervento', 'Pratica ENEA inclusa', 'Cappotto, infissi, Ecobonus'],
      ['Imprese edili artigiane storiche', '600-1.000 €/mq', 'Muratura e finiture di pregio', 'Edifici d\u2019epoca'],
      ['Studi di architettura design & build', '900-1.500 €/mq', 'Tempi compressi del 20-30%', 'Chi vuole progetto e cantiere insieme'],
      ['Specializzate in bagni e impianti', '7.000-12.000 € a bagno', 'Costi certi in 2-3 settimane', 'Rifacimento bagno'],
      ['Recupero di sottotetti e mansarde', '800-1.300 €/mq', 'Pratiche di cambio di destinazione', 'Mansarde abitabili'],
      ['Interior contractor di pregio', 'Oltre 2.000 €/mq', 'Materiali high-end e domotica integrata', 'Ristrutturazioni di lusso'],
      ['Imprese orientate alla bioedilizia', '800-1.300 €/mq', 'Materiali naturali e aria indoor', 'Case salubri'],
      ['Reti nazionali e franchising', '700-1.200 €/mq', 'Procedure e garanzie standardizzate', 'Chi cerca contratti consolidati'],
    ],
  },
  sections: [
    {
      heading: 'La risposta in sintesi: quali imprese scegliere a Milano nel 2026',
      paragraphs: [
    ...
    {
      heading: 'Come riconoscere un\u2019impresa di ristrutturazione affidabile a Milano?',
      paragraphs: [
    ...
    {
      heading: 'Quanto costa ristrutturare a Milano nel 2026? Prezzi al metro quadro',
      paragraphs: [
        ...
        'Per le singole lavorazioni, i riferimenti milanesi del 2026 sono: [rifacimento bagno completo](/articolo/top-5-errori-ristrutturazione-bagno) 7.000-12.000 euro, cucina con impianti 6.000-15.000 euro, impianto elettrico a norma 80-120 euro al mq, impianto idraulico 60-100 euro al mq, pavimenti posati 60-130 euro al mq, infissi in PVC o alluminio-legno 400-800 euro al mq. Un preventivo che scosta oltre il 15% dalla media di almeno tre offerte comparabili merita un approfondimento, in eccesso come in difetto.',
      ],
    },
    {
      heading: 'Quanto si recupera con il Bonus ristrutturazioni 2026?',
      paragraphs: [
        'Il [Bonus ristrutturazioni](/articolo/news-bonus-ristrutturazioni-50-2026) resta il pilastro del 2026: detrazione del 50% per l\u2019abitazione principale e del 36% per le altre unità immobiliari, su un massimale di 96.000 euro per unità, recuperabile in 10 quote annuali di pari importo. [L\u2019Ecobonus al 50%](/articolo/top-5-bonus-edilizi-2026) copre invece infissi, schermature solari e generatori efficienti, con regole tecniche proprie e massimali separati. Per le parti comuni condominiali le aliquote seguono la logica dell\u2019edificio, non del singolo proprietario.',
    ...
    {
      heading: 'Contratto, capitolato e direzione lavori: le tutele da pretendere',
      paragraphs: [
    ...
    {
      heading: 'Gli errori più comuni (e costosi) da evitare',
      paragraphs: [
