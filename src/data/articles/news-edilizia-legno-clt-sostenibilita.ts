...
const article: Article = {
  slug: 'news-edilizia-legno-clt-sostenibilita',
  title: 'Edilizia in legno CLT 2026: la scommessa sostenibile cresce',
  h1: 'Edilizia in legno e CLT nel 2026: cresce la costruzione sostenibile, numeri, vantaggi e progetti in Italia',
  category: 'news',
  subcategory: 'Sostenibilit\u00e0',
  excerpt:
    'Edilizia in legno CLT: cresce il mercato italiano degli edifici multipiano in X-Lam, tra CO2 stoccata e cantieri rapidi antisismici. Dati e progetti 2026.',
  keywords: [
    'edilizia in legno',
    'CLT pannelli strutturali',
    'X-Lam case in legno',
    'case in legno Italia 2026',
    'costruzioni sostenibili legno',
    'edifici multipiano legno',
    'legno strutturale antisismico',
    'bioedilizia 2026',
    'certificazione PEFC FSC legno',
    'quanto costa casa in legno',
  ],
  publishedAt: '2026-06-18T09:00:00+02:00',
  updatedAt: '2026-06-18T09:00:00+02:00',
  author: { name: 'Giulia Colombo', role: 'Giornalista edilizia' },
  readingTime: 10,
  faq: [
    {
      q: 'Cos\u2019\u00e8 il CLT nell\u2019edilizia in legno?',
      a: "Il CLT (Cross Laminated Timber, in Italia anche X-Lam) \u00e8 un pannello strutturale in legno formato da strati di tavole incollate a strati incrociati: ha prestazioni meccaniche comparabili a elementi in calcestruzzo e laterizio, con un peso molto inferiore. Si usa per pareti, solai e coperture di edifici anche multipiano, con montaggio a secco in cantiere.",
    },
    {
      q: 'Le case in legno sono sicure in caso di terremoto?',
      a: "S\u00ec, e sono tra le tipologie pi\u00f9 performanti: gli edifici in legno hanno un peso proprio ridotto — quindi minori forze sismiche — e connessioni metalliche progettate per dissipare energia. L'esperienza dei terremoti italiani ha mostrato ottime prestazioni degli edifici in legno ben progettati, e le Norme Tecniche per le Costruzioni ne regolano la progettazione antisismica.",
    },
    {
      q: 'Il legno in edilizia brucia facilmente?',
      a: "Le strutture in legno massiccio come il CLT hanno un comportamento al fuoco prevedibile: la carbonizzazione superficiale avanza a velocit\u00e0 nota e protegge il cuore dell'elemento, consentendo il dimensionamento della resistenza al fuoco come per le altre tecnologie. I sistemi costruttivi certificati raggiungono le classi di resistenza richieste dalle norme antincendio.",
    },
    {
      q: 'Il legno usato in edilizia \u00e8 certificato?',
      a: "La filiera seria lavora con legname certificato PEFC o FSC, che garantisce la gestione forestale responsabile e il rimboschimento. La filiera corta alpina — abete da foreste certificate italiane, austriache e tedesche lavorato in stabilimenti europei — riduce l'impatto dei trasporti; da evitare legnami tropicali e filiere opache, che possono ribaltare il bilancio ambientale.",
    },
    {
      q: 'Quanto costa costruire una casa in legno nel 2026?',
      a: "Il costo di costruzione di un edificio in legno chiavi in mano \u00e8 stimato dagli operatori in una fascia comparabile o leggermente superiore alla costruzione tradizionale di pari livello — indicativamente tra i 1.800 e i 2.600 euro al metro quadrato per standard elevati — con vantaggi su tempi di cantiere, prestazioni energetiche e comfort che migliorano il rapporto costo-valore.",
    },
    {
      q: 'L\u2019edilizia in legno \u00e8 davvero sostenibile?',
      a: "Il legno \u00e8 l'unico materiale strutturale rinnovabile e stocca carbonio per tutta la vita dell'edificio: ogni metro cubo di legno strutturale trattiene indicativamente intorno a una tonnellata di CO2 equivalente. La sostenibilit\u00e0 dipende dalla filiera: certificazioni PEFC e FSC garantiscono la gestione forestale responsabile, e la filiera corta alpina italiana ed europea riduce l'impatto dei trasporti.",
    },
  ],
  sections: [
    {
      heading: 'Edilizia in legno: il mercato italiano cresce nel 2026',
      paragraphs: [
        ...
        "Il legno strutturale \u00e8 passato in pochi anni da nicchia della bioedilizia a soluzione competitiva per edifici multipiano, trainato dalla [domanda di sostenibilit\u00e0](/categoria/sostenibilita), dalla velocit\u00e0 di cantiere e dalle ottime prestazioni sismiche dimostrate sul territorio italiano. A spingere la crescita concorrono fattori di contesto potenti: la [Direttiva Case Green](/articolo/news-direttiva-case-green-recepimento-italia), che porta l'attenzione sul carbonio incorporato dei materiali e premia un materiale che stocca CO2 invece di emetterla; i [CAM edilizia](/articolo/news-cam-edilizia-normativa-2026), che nelle gare pubbliche valorizzano i materiali rinnovabili e certificati; e la maturit\u00e0 industriale della filiera, con stabilimenti di produzione di CLT e legno lamellare attivi tra Italia e area alpina europea.",
    ...
    {
      heading: 'Cos\u2019\u00e8 il CLT e come si costruisce in legno oggi?',
      paragraphs: [
    ...
    {
      heading: 'Perch\u00e9 l\u2019edilizia in legno \u00e8 sostenibile? Il legno che stocca CO2',
      paragraphs: [
        ...
        "Gli studi di valutazione del ciclo di vita mostrano che un edificio in legno pu\u00f2 avere un'impronta di carbonio incorporata inferiore anche del 40-60% rispetto a un [equivalente in cemento armato](/articolo/news-calcestruzzo-sostenibile-innovazioni), a seconda delle soluzioni e della filiera. Un dato che acquista peso con la Direttiva Case Green, che introduce la rendicontazione del carbonio dell'intero ciclo di vita degli edifici: il legno parte da una posizione di vantaggio strutturale.",
    ...
    {
      heading: 'Le case in legno sono sicure? Sisma, fuoco, energia e durabilit\u00e0',
      paragraphs: [
