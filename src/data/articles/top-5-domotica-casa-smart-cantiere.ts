...
const article: Article = {
  slug: 'top-5-domotica-casa-smart-cantiere',
  title: 'Domotica ristrutturazione 2026: 5 soluzioni smart',
  h1: 'Domotica in ristrutturazione: le 5 soluzioni smart da prevedere in cantiere nel 2026',
  category: 'top-5',
  excerpt:
    'Termoregolazione, luci, sicurezza, tapparelle ed energia: le 5 soluzioni domotiche da integrare in ristrutturazione nel 2026, con costi reali e bonus.',
  keywords: [
    'domotica ristrutturazione',
    'casa smart 2026',
    'impianto domotico costo',
    'termostato smart',
    'domotica detraibile bonus 2026',
    'automazione tapparelle',
    'smart home ristrutturazione',
    'impianto domotico cablato o wireless',
    'termoregolazione a zone',
    'building automation Ecobonus',
  ],
  ...
  faq: [
    {
      q: 'Quanto costa rendere smart una casa in ristrutturazione?',
      a: 'Un impianto domotico di base (termostato smart, alcune luci comandate, tapparelle motorizzate) parte da 2.000-4.000 euro integrato nella ristrutturazione; un sistema completo con gestione di clima, luci, sicurezza, tapparelle ed energia su un appartamento di 100 metri quadri costa tra 6.000 e 15.000 euro. Integrarlo durante i lavori costa il 30-50% in meno che dopo.',
    },
    {
      q: 'La domotica è detraibile con i bonus edilizi 2026?',
      a: 'Sì, in due modi: gli interventi di building automation che gestiscono impianti termici possono rientrare nell’Ecobonus se asseverati con i requisiti previsti, mentre la domotica inserita in una ristrutturazione complessiva può seguire il Bonus ristrutturazioni al 50% sull’abitazione principale. La scelta del regime va fatta in fase di progetto con il termotecnico.',
    },
    {
      q: 'Meglio un sistema domotico cablato o wireless?',
      a: 'In ristrutturazione con tracce aperte il cablato (bus dedicato) resta la scelta più affidabile e durevole: non dipende dal Wi-Fi e dura quanto l’impianto elettrico. Il wireless è la soluzione ideale per integrazioni successive, appartamenti senza rifacimento impianti e affitti, ma richiede attenzione a copertura di rete e aggiornamenti.',
    },
    {
      q: 'Cosa conviene automatizzare per primo in casa?',
      a: 'Il clima: la termoregolazione a zone con testine o valvole smart e cronotermostato è l’intervento con il miglior rapporto tra costo e risparmio, con tagli in bolletta tipici del 10-20% sul riscaldamento. Subito dopo vengono le tapparelle motorizzate, che incidono sia sul comfort sia sul carico termico estivo.',
    },
    {
      q: 'La domotica aumenta il valore dell’immobile?',
      a: 'Sì, indirettamente: un impianto domotico documentato migliora la certificazione energetica quando gestisce il clima, e le valutazioni di mercato 2026 premiano gli appartamenti con predisposizioni e automazioni già integrate. Il valore aggiunto si concentra però su sistemi aperti e manutenibili, non su gadget obsolescibili.',
    },
    {
      q: 'Serve predisporre la domotica anche se non la installo subito?',
      a: 'Sì, ed è la decisione più intelligente in fase di cantiere: tubi corrugati di riserva, cassette di derivazione sovradimensionate, linee dati nei punti strategici e quadro elettrico con moduli liberi costano poche centinaia di euro a parete aperta e migliaia a parete chiusa. La predisposizione vale più di qualsiasi dispositivo.',
    },
  ],
  sections: [
    {
      heading: 'Domotica in ristrutturazione: la Top 5 del 2026 in sintesi',
      paragraphs: [
        'Cosa conviene automatizzare quando si ristruttura casa nel 2026? Le cinque soluzioni con il miglior rapporto costo-beneficio sono: termoregolazione a zone, illuminazione gestita, sicurezza integrata, tapparelle e schermature motorizzate, gestione dell’energia con [fotovoltaico](/articolo/top-10-impianti-fotovoltaici-domestici-2026) e carichi smart. Integrate durante i lavori costano dal 30 al 50% in meno che a pareti chiuse.',
        'Il motivo è fisico: la domotica vive nei corrugati, nelle cassette di derivazione e nel quadro elettrico. Ogni metro di cavo bus o di linea dati posato durante la ristrutturazione costa una frazione di quello che costerà dopo, tra tracce, ripristini e imbiancature. Il 2026 aggiunge un motivo fiscale: gli interventi di building automation sugli impianti termici possono rientrare [nell’Ecobonus](/articolo/top-5-bonus-edilizi-2026), mentre la domotica inserita in una ristrutturazione complessiva può seguire il [Bonus ristrutturazioni al 50%](/articolo/news-bonus-ristrutturazioni-50-2026) sull’abitazione principale.',
    ...
    {
      heading: '1. Quanto si risparmia con la termoregolazione a zone?',
      paragraphs: [
        ...
        'In ristrutturazione la scelta più strutturata è la centrale di zona con attuatori cablati: più costosa delle testine wireless (150-300 euro a zona contro 60-120 euro a testina), ma esente da batterie e da problemi di copertura radio. Con caldaia sostituita o [pompa di calore](/articolo/top-10-pompe-di-calore-2026) nuova, la termoregolazione evoluta è spesso obbligatoria per il rispetto dei requisiti minimi di efficienza e apre la strada agli incentivi.',
    ...
    {
      heading: '2. Illuminazione gestita: scenari, presenza e luce naturale',
      paragraphs: [
    ...
    {
      heading: '3. Antifurto smart: meglio cablato o wireless?',
      paragraphs: [
    ...
    {
      heading: '4. Quanto costa motorizzare le tapparelle nel 2026?',
      paragraphs: [
    ...
    {
      heading: '5. Gestione dell’energia: monitoraggio, fotovoltaico e carichi smart',
      paragraphs: [
