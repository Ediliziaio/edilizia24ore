...
const article: Article = {
  slug: 'news-calcestruzzo-sostenibile-innovazioni',
  title: 'Calcestruzzo sostenibile 2026: le innovazioni anti-CO2',
  h1: 'Calcestruzzo sostenibile nel 2026: cementi a basso clinker, CO2 mineralizzata e riciclo, le innovazioni in cantiere',
  category: 'news',
  subcategory: 'Innovazione',
  excerpt:
    'Calcestruzzo sostenibile: il cemento emette il 7-8% della CO2 globale. Le innovazioni 2026: cementi a basso clinker, aggregati riciclati e CO2 mineralizzata.',
  keywords: [
    'calcestruzzo sostenibile',
    'cemento basso clinker',
    'emissioni CO2 cemento',
    'calcestruzzo riciclato aggregati',
    'cattura CO2 calcestruzzo mineralizzazione',
    'decarbonizzazione cemento',
    'CAM edilizia calcestruzzo',
    'EPD calcestruzzo',
    'geopolimeri leganti alternativi',
    'impronta carbonio edifici direttiva case green',
  ],
  publishedAt: '2026-06-26T08:30:00+02:00',
  updatedAt: '2026-06-26T08:30:00+02:00',
  author: { name: 'Geom. Nicola Trevisan', role: 'Corrispondente cantieri' },
  readingTime: 10,
  faq: [
    {
      q: 'Perch\u00e9 il calcestruzzo inquina?',
      a: "L'impatto ambientale del calcestruzzo deriva soprattutto dal cemento, il suo legante: la produzione del clinker richiede la cottura del calcare a circa 1.450 \u00b0C, processo che emette CO2 sia per la combustione sia per la decarbonatazione chimica della roccia. La produzione mondiale di cemento genera secondo le stime internazionali intorno al 7-8% delle emissioni globali di CO2.",
    },
    {
      q: 'Cos\u2019\u00e8 un cemento a basso contenuto di clinker?',
      a: "\u00c8 un cemento in cui una parte del clinker \u00e8 sostituita da costituenti alternativi — loppa d'altoforno, ceneri volanti, pozzolane, calcare macinato — che riducono le emissioni incorporate mantenendo le prestazioni meccaniche. I cementi a basso clinker possono tagliare l'impronta di carbonio del 20-50% rispetto al cemento Portland puro e sono coperti dalle norme europee di prodotto.",
    },
    {
      q: 'Il calcestruzzo riciclato si pu\u00f2 usare nelle strutture?',
      a: "S\u00ec, con limiti definiti dalle Norme Tecniche per le Costruzioni. Gli aggregati riciclati da demolizione possono sostituire quote crescenti di aggregato naturale nei calcestruzzi strutturali, purch\u00e9 il prodotto rispetti requisiti di resistenza e durabilit\u00e0 verificati in laboratorio. I CAM edilizia e le gare pubbliche premiano l'uso di materiali riciclati.",
    },
    {
      q: 'Cos\u2019\u00e8 la mineralizzazione della CO2 nel calcestruzzo?',
      a: "\u00c8 una tecnologia che inietta anidride carbonica catturata nel calcestruzzo fresco o nei prodotti prefabbricati in vibrocompresso, dove la CO2 reagisce con i composti del cemento e si trasforma in carbonati stabili, restituendo anche un effetto di accelerazione della resistenza. La CO2 resta cos\u00ec stoccata permanentemente nel materiale.",
    },
    {
      q: 'Il calcestruzzo sostenibile costa di pi\u00f9?',
      a: "Le prime produzioni di calcestruzzi a bassa impronta hanno un sovrapprezzo che gli operatori stimano nell'ordine del 10-30% rispetto al prodotto standard, destinato a ridursi con la scala industriale. Nei progetti pubblici e nei grandi sviluppi privati il costo aggiuntivo \u00e8 gi\u00e0 compensato dai crediti ambientali, dai requisiti CAM e dalla maggiore commerciabilit\u00e0 degli edifici certificati.",
    },
    {
      q: 'I CAM edilizia premiano il calcestruzzo riciclato?',
      a: "S\u00ec. I Criteri Ambientali Minimi per l'edilizia fissano contenuti minimi di materiale riciclato che le stazioni appaltanti devono richiedere nelle gare pubbliche, e molti bandi assegnano punteggi premiali alle forniture con EPD di prodotto e quote certificate di aggregato riciclato. Per le imprese, rispettare i CAM \u00e8 ormai una condizione di accesso al mercato degli appalti.",
    },
  ],
  sections: [
    {
      heading: 'Calcestruzzo sostenibile: perch\u00e9 \u00e8 la sfida decisiva del 2026',
      paragraphs: [
        "Il calcestruzzo \u00e8 il materiale pi\u00f9 usato al mondo dopo l'acqua: la produzione del cemento genera, secondo le stime internazionali, circa il 7-8% delle emissioni globali di CO2. Nel 2026 la filiera italiana risponde con cementi a basso clinker (meno 20-50% di emissioni), aggregati riciclati e mineralizzazione della CO2, spinta dai CAM e dalla [Direttiva Case Green](/articolo/news-direttiva-case-green-recepimento-italia).",
    ...
    {
      heading: 'Cos\u2019\u00e8 un cemento a basso clinker e quanta CO2 risparmia?',
      paragraphs: [
    ...
    {
      heading: 'Cos\u2019\u00e8 la mineralizzazione della CO2? Le tecnologie di frontiera',
      paragraphs: [
        ...
        "Completano il quadro le tecnologie digitali: [l'intelligenza artificiale applicata al mix design](/categoria/innovazione) ottimizza dosaggi e costituenti per ogni specifica applicazione, riducendo il cemento impiegato a parit\u00e0 di prestazioni; la sensoristica in cantiere certifica la maturazione e la durabilit\u00e0 attesa; e i passaporti digitali dei materiali, che la regolamentazione europea dei prodotti da costruzione sta introducendo, renderanno l'impronta di carbonio di ogni fornitura tracciata e verificabile.",
      ],
    },
    {
      heading: 'Cantieri italiani: dove il calcestruzzo verde \u00e8 gi\u00e0 realt\u00e0',
      paragraphs: [
    ...
    {
      heading: 'Quando sar\u00e0 obbligatoria la rendicontazione del carbonio?',
      paragraphs: [
