...
const article: Article = {
  slug: 'news-sicurezza-cantieri-decreto-2026',
  title: 'Sicurezza cantieri 2026: il nuovo decreto, cosa cambia',
  h1: 'Sicurezza nei cantieri, il decreto 2026: patentino a punti, pi\u00f9 controlli e nuove responsabilit\u00e0',
  category: 'news',
  subcategory: 'Normative',
  excerpt:
    'Decreto sicurezza cantieri 2026: patentino a punti per imprese e lavoratori, pi\u00f9 controlli INL e INAIL, sanzioni severe. Cosa cambia per datori e RSPP.',
  keywords: [
    'sicurezza cantieri 2026',
    'decreto sicurezza lavoro 2026',
    'patentino a punti cantieri',
    'patentino credito sicurezza imprese edili',
    'infortuni edilizia INAIL',
    'testo unico sicurezza D.Lgs 81/08',
    'controlli INL cantieri edili',
    'formazione sicurezza lavoratori edili',
    'cadute dall\u2019alto infortuni cantiere',
    'sanzioni sicurezza cantiere sospensione',
  ],
  ...
  faq: [
    {
      q: 'Cos\u2019\u00e8 il patentino a punti per le imprese edili?',
      a: "\u00c8 un meccanismo di \u201ccredito\u201d della sicurezza introdotto dal decreto: ogni impresa che opera nei cantieri parte con un punteggio iniziale che pu\u00f2 essere decurtato in caso di violazioni accertate o infortuni gravi. Sotto determinate soglie scattano limitazioni operative fino alla sospensione dell'attivit\u00e0, con possibilit\u00e0 di recuperare punti tramite formazione aggiuntiva e verifiche di regolarit\u00e0.",
    },
    {
      q: 'Il decreto sicurezza 2026 modifica il Testo Unico?',
      a: "Il decreto interviene a integrazione del D.Lgs 81/08 e successive modifiche, senza sostituirlo. Rafforza le prescrizioni su ponteggi, scavi e lavori in quota, estende gli obblighi di formazione verificabile e introduce strumenti premiali e sanzionatori legati al nuovo sistema a punti, oltre a una cabina di regia permanente per i controlli coordinati tra INL, INAIL e ATS.",
    },
    {
      q: 'Quando entra in vigore il decreto sicurezza cantieri 2026?',
      a: "Il decreto \u00e8 stato approvato nel 2026 e le sue disposizioni principali si applicano con l'entrata in vigore del testo, mentre il sistema a punti e il registro nazionale della formazione richiedono decreti attuativi ministeriali attesi nei mesi successivi. Le associazioni di categoria consigliano alle imprese di adeguare documenti e procedure gi\u00e0 nella fase transitoria.",
    },
    {
      q: 'Quali sono le sanzioni previste per le violazioni?',
      a: "Le sanzioni amministrative per violazioni in materia di sicurezza nei cantieri restano di competenza del Testo Unico, ma il decreto 2026 inasprisce l'apparato: sospensione immediata dell'attivit\u00e0 per lavori in quota senza protezioni, importi raddoppiati in caso di recidiva e possibilit\u00e0 di blocco del cantiere anche per mancata formazione documentata dei lavoratori presenti.",
    },
    {
      q: 'La formazione per la sicurezza cambia con il nuovo decreto?',
      a: "S\u00ec. Il decreto rafforza la verifica dell'effettivit\u00e0 della formazione: corsi tracciati, test di apprendimento obbligatori e registro nazionale dei lavoratori formati. Restano obbligatori i corsi di base, quelli specifici per i lavori in quota, per ponteggiatori e per l'uso di attrezzature, con aggiornamenti periodici che entrano a far parte del sistema a punti.",
    },
    {
      q: 'Quanti infortuni ci sono ancora nei cantieri italiani?',
      a: "Secondo i dati INAIL, le denunce di infortunio nel settore delle costruzioni si attestano ogni anno nell'ordine delle decine di migliaia, con un'incidenza sul totale nazionale superiore al peso occupazionale del comparto e casi mortali che rappresentano una quota rilevante delle vittime sul lavoro in Italia. Le cadute dall'alto restano la prima causa di infortunio mortale.",
    },
  ],
  sections: [
    {
      heading: 'Il decreto sicurezza cantieri 2026: cosa prevede in sintesi',
      paragraphs: [
    ...
    {
      heading: 'Come funziona il patentino a punti per imprese e lavoratori?',
      paragraphs: [
    ...
    {
      heading: 'Controlli e ispezioni: la stretta coordinata di INL, INAIL e ATS',
      paragraphs: [
    ...
    {
      heading: 'Formazione, ponteggi e lavori in quota: le prescrizioni tecniche',
      paragraphs: [
    ...
    {
      heading: 'Quanti infortuni ci sono ancora nei cantieri italiani?',
      paragraphs: [
        ...
        "Gli effetti del ciclo dei bonus edilizi si fanno sentire anche qui: [il boom dei cantieri di ristrutturazione](/articolo/top-5-bonus-edilizi-2026) degli ultimi anni ha moltiplicato il numero di imprese attive e di lavoratori impiegati, non sempre con un corrispondente rafforzamento delle strutture di prevenzione. Il decreto 2026 \u00e8 pensato proprio per riallineare il perimetro delle regole a un mercato che, secondo [le stime ANCE](/articolo/news-settore-costruzioni-2026-rapporto-ance), impiega oggi oltre un milione e mezzo di addetti tra diretti e indotto.",
      ],
    },
    {
      heading: 'Cosa devono fare le imprese per adeguarsi? La checklist operativa',
      paragraphs: [
