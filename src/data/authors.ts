...
export const authors: Author[] = [
  {
    slug: 'marco-ferrante',
    name: 'Ing. Marco Ferrante',
    role: 'Redattore tecnico impianti',
    bio: 'Ingegnere meccanico, si occupa di pompe di calore, caldaie e impianti HVAC dal 2012. Segue per Edilizia 24 Ore le prove di prodotto sugli impianti termici e le analisi di rendimento stagionale.',
    credential: 'Ingegnere meccanico',
    expertise: ['Impianti termici', 'Pompe di calore', 'Fotovoltaico', 'Efficienza energetica'],
  },
  {
    slug: 'elena-riva',
    name: 'Dott.ssa Elena Riva',
